...
int pdf_measure_pages_json(const uint8_t *data, uintptr_t len, uint8_t **out_ptr, uintptr_t *out_len);
int pdf_inspect_json(const uint8_t *data, uintptr_t len, uint8_t **out_ptr, uintptr_t *out_len);
